    ...
    <div className="fixed bottom-6 right-5 z-50 flex items-center gap-3" style={{ bottom: 'max(24px, env(safe-area-inset-bottom, 24px))' }}>
      ...
      >
        <div className="relative bg-gray-900 text-white text-xs font-medium px-3 py-2 rounded-lg whitespace-nowrap shadow-xl">
          ¿Necesitas ayuda? 💬
          <span className="absolute right-[-5px] top-1/2 -translate-y-1/2 border-[5px] border-transparent border-l-gray-900" />
        </div>
      </div>
      ...
      <a
        ...
        className="relative w-14 h-14 flex items-center justify-center rounded-full shadow-xl hover:scale-110 active:scale-95 transition-transform duration-200"
